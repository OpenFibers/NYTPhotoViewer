Pod::Spec.new do |s|
  ...
  s.source           = { :git => "http://gitlab.alibaba-inc.com/aiframework/AENYTPhotoViewer", :tag => s.version.to_s }

  s.platform     = :ios, '8.0'
  s.requires_arc = true

  s.subspec 'Core' do |ss|
    ss.resources = ["NYTPhotoViewer/NYTPhotoViewer.bundle/*"]
